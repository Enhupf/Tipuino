//test of serial communication with motor driver via UART. Functionality has been confimred for the one tested axis (dispenser)
//Working version for testing inclusion of other axes using UART communication
...
LiquidCrystal_I2C lcd(0x27, 16, 2);
  ...
  void setup() {
   ...
   lcd.print("Tipuino starting");
    ...
    DISPENSER_UART.begin(115200);
    delay(50);
    dispenserDriver.begin();     // init driver
    dispenserDriver.toff(4);     // enable driver
    dispenserDriver.rms_current(600); // motor RMS current in mA
    dispenserDriver.microsteps(16);   // microstepping
    dispenserDriver.en_pwm_mode(true); // stealthChop
